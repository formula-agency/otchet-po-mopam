...
После выбора файла dashboard открывает GitHub для подтверждения публикации. GitHub Action сохраняет план в `manual-data/shared-plans.json`, пересобирает Pages, после чего один и тот же план отображается на всех устройствах и во всех сеансах. Публиковать и удалять планы могут владельцы и участники репозитория.
